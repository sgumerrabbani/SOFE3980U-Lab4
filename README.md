...
The folder (/SVCR)[/SVCR] in the GitHub contains a Maven-managed Java program. The program, (App.java)[/SVCR/src/main/java/com/ontariotechu/sofe3980U/App.java], reads a CSV file, called model_1, and displays the first  lines of the data.
